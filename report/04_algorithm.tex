...
\textbf{paragraph or footnote on policies and Bellman equation?}
...
if the system were stationary --> convergence guarantee (e.g. Jaakoola et al. 1994). However, non-stationarity induced by multi-agent learning breaks that guarantee (moving target problem). To my knowledge, no guarantees, but empirically strong results